...
console.log(chalk.bold.hex("#00ffff").bold("[ MrTomXxX (MTX) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`MrTomXxX`, '[ MrTomXxX (MTX) ]');
        logger('Hey, thank you for using this Bot', '[ MrTomXxX (MTX) ]');
        logger("Fixed by MrTomXxX", '[ MrTomXxX (MTX) ]');
...
cron.schedule('0 0 0 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    ...
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day (Cradit:- aadi ji ne aapko hasne k liya banaya hain 🙂 (AADI))", now.threadID) : '');
  });
}, {
  scheduled: true,
...
cron.schedule('0 0 1 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day 🌸===『*★𝗖𝗿𝗲𝗱𝗶𝘁'𝘀 𒁍आदि बाबू", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 5 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day (Cradit:- आदि", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodmorning everyone, have a nice day (Cradit:- MrTomXxX (MTX))", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 12 7 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Hi, good morning have a nice day ❤🙏", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 7 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Goodafternoon humans, let's eat🌸===『*★𝗖𝗿𝗲𝗱𝗶𝘁'𝘀 𒁍आदि बाबू", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 30 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("How's your eat?, have you eaten? (Cradit :- aadi", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("good afternoon 12 baj gaye hain pata nahin mere Boss kahan hai", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good evening dear🙂🙏", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 22 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Ok aap So jao thak gye hoge hawabaazi krke🙏🙂😜", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
